...
exports.NotificationTemplate = exports.InvitationTemplate = exports.ResetPasswordTemplate = exports.NotificationSchema = exports.InvitationSchema = exports.ResetPasswordSchema = exports.SendEmailSchema = void 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hello, ${name},</p>
            <p>We received a request to reset your password for the OAU College of Health Sciences Results Portal. Click the button below to reset your password:</p>
...
const InvitationTemplate = ({ name, registrationLink, }) => {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const NotificationTemplate = ({ name, title, message, portalLink, }) => {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
